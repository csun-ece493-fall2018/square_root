...
HD_PWD='C:/Users/hs696802/Desktop/square_root/square_root.runs/square_rooter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log square_rooter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source square_rooter.tcl
